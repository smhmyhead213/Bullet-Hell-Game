...
namespace bullethellwhatever.BaseClasses.Hitboxes
{
    public static class HitboxUtils
    {
        ...
        {
            return FillRectWithCircles(centre, width, height, rotation, (x) => 0);
        }
        public static List<Circle> FillRectWithCircles(Vector2 centre, int width, int height, float rotation, Func<float, float> centreOffsetFunction)
        {
