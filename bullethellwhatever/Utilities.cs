...
public class Utilities
{
    ...
    {
        var distance =
            MathF.Sqrt(vectorToNormalise.X * vectorToNormalise.X + vectorToNormalise.Y * vectorToNormalise.Y);
    ...
    {
        return MathF.Sqrt(MathF.Pow(entity1.Position.X - entity2.Position.X, 2) +
                          MathF.Pow(entity1.Position.Y - entity2.Position.Y, 2));
    }
