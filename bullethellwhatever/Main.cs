...
public class Main : Game
{
    ...
    public static GameStateHandler gameStateHandler = new();
    public static GameState gameState = new();

    public static List<NPC> activeNPCs = new();
    public static List<Projectile> activeProjectiles = new();
    public static List<FriendlyProjectile> activeFriendlyProjectiles = new();
    public static List<Projectile> enemyProjectilesToAddNextFrame = new();
    public static List<FriendlyProjectile> friendlyProjectilesToAddNextFrame = new();
    public static List<NPC> NPCsToAddNextFrame = new();

    public static Player player = new();

    public static List<Button> activeButtons = new();
