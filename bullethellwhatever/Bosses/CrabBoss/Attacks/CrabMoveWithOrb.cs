        ...
        public override void Execute(int AITimer)
        {
            ...
            if (AITimer == 0)
            {
                for (int i = 0; i < 2; i++)
                {
                    ...
                    Projectile orb = SpawnProjectile<Projectile>(projectileLocation, Vector2.Zero, 1f, 1, "box", Vector2.One, Owner, true, false, Color.White, false, false);
                    ...
                    orb.SetExtraAI(new Action(() =>
                    {
                        ...
                        if (orb.AITimer > timeAfterOrbSpawnToStartFiringProjectiles && orb.AITimer % 10 == 0)
                        {
                            ...
                            Projectile p = SpawnProjectile<Projectile>(orb.Position, 5f * Utilities.AngleToVector(shootAngle), 1f, 1, "box", Vector2.One, Owner, true, false, Color.Red, true, false);
